...
2. 默认“激进 1400B + 单码”。距离近、画面稳定时可以选择双码；反光、抖动或对焦困难时切换“高速 896B”或“稳定 512B”。
...
二维码光学传输的速度仍远低于 Wi-Fi/数据线。1400B 单码在 30fps 且每帧都成功识别的理论载荷上限约 41 KB/s；双码理论上翻倍，但二维码变小后丢帧率可能上升。实际应以接收端有效符号增长速度为准。RaptorQ 会持续发送新的修复符号，丢帧不会要求重传整个文件。
