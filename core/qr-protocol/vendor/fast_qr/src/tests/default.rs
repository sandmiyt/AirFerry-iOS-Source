...
pub const DARK: fn(bool) -> Module = Module::dark;
pub const DATA: fn(bool) -> Module = Module::data;
pub const ALIG: fn(bool) -> Module = Module::alignment;
pub const FORM: fn(bool) -> Module = Module::format;
pub const VERS: fn(bool) -> Module = Module::version;
pub const TIMG: fn(bool) -> Module = Module::timing;
pub const FIND: fn(bool) -> Module = Module::finder_pattern;
pub const EMPT: fn(bool) -> Module = Module::empty;
