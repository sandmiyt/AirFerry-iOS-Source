...
pub fn encode_numeric(compact: &mut CompactQR, input: &[u8], cci_bits: usize) {
    #[derive(Clone, Copy)]
...
pub fn encode_alphanumeric(compact: &mut CompactQR, input: &[u8], cci_bits: usize) {
...
pub fn encode_byte(compact: &mut CompactQR, input: &[u8], cci_bits: usize) {
...
pub fn ascii_to_alphanumeric(c: u8) -> usize {
    match c {
